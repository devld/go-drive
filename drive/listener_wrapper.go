...
type ListenerWrapper struct {
	...
	event types.DriveEvent
	bus   event.Bus
}

func NewListenerWrapper(drive types.IDrive, event types.DriveEvent, bus event.Bus) *ListenerWrapper {
...
func (d *ListenerWrapper) Get(ctx context.Context, path string) (types.IEntry, error) {
	...
	if e == nil {
		d.bus.PublishEntryAccessed(d.event, path)
	}
	return entry, e
}
...
func (d *ListenerWrapper) Save(ctx types.TaskCtx, path string, size int64, override bool, reader io.Reader) (types.IEntry, error) {
	...
	if e == nil {
		d.bus.PublishEntryUpdated(d.event, path, false)
	}
	return entry, e
}
...
func (d *ListenerWrapper) Copy(ctx types.TaskCtx, from types.IEntry, to string, override bool) (types.IEntry, error) {
	...
	if e == nil {
		d.bus.PublishEntryAccessed(d.event, from.Path())
		d.bus.PublishEntryUpdated(d.event, entry.Path(), true)
	}
	return entry, e
}
...
func (d *ListenerWrapper) Move(ctx types.TaskCtx, from types.IEntry, to string, override bool) (types.IEntry, error) {
	...
	if e == nil {
		d.bus.PublishEntryDeleted(d.event, from.Path())
		d.bus.PublishEntryUpdated(d.event, entry.Path(), true)
	}
	return entry, e
}
...
func (d *ListenerWrapper) Delete(ctx types.TaskCtx, path string) error {
	...
	if e == nil {
		d.bus.PublishEntryDeleted(d.event, path)
	}
	return e
}
